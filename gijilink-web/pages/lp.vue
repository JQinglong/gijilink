  ...
  <div>
    <div class="hero min-h-80 bg-base-200">
      <div class="hero-content text-center">
        <div class="max-w-lg">
          <h1 class="text-5xl font-bold">議事録リンク - Giji Link</h1>
          <p class="py-6">
    ...
    <div class="card card-side bg-base-100 shadow-xl m-8">
      <figure>
        <svg
      ...
      <div class="card-body">
        <h2 class="card-title">どんな会議体があるのか</h2>
        <p class="text-left">
    ...
    <div class="card card-side bg-base-100 shadow-xl m-8">
      ...
      <div class="card-body">
        <h2 class="card-title">会議体にはどんな立場の人が参加しているのか</h2>
        <p class="text-left">
    ...
    <div class="card card-side bg-base-100 shadow-xl m-8">
      ...
      <div class="card-body">
        <h2 class="card-title">この人は、どの会議に参加しているのか</h2>
        <p class="text-left">
    ...
    <div class="card card-side bg-base-100 shadow-xl m-8">
      ...
      <div class="card-body">
        <h2 class="card-title">市民による行政活動への参加のために</h2>
        <p class="text-left">
          結局のところこれは、市民による、行政の議論への参加のためのツールです。<br />
          会議体において、本当に多様な意見が反映されているのか、これを監視するところからでも行政活動への参加は始められます。<br />
          さらに、会議体への議論について討論をすることで、参加者への働きかけもできるようになるでしょう。<br />
          できることは色々あるはずです。
        </p>
      </div>
    </div>
